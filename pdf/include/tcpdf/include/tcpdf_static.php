...
class TCPDF_STATIC {
	...
	* @since 5.9.121 (2011-09-28)
	 ...
	 * @public static
	 */
	public static function fixHTMLCode($html, $default_css, $tagvs, $tidy_options, &$tagvspaces) { // $default_css='', $tagvs='', $tidy_options='',
...
// ====================================================================================================================
	 ...
	 * @public static
	 */
	public static function setPageBoxes($page, $type, $llx, $lly, $urx, $ury, $points , $k, $pagedim ) { //  $points=false, $k, $pagedim=array()
