...
function jigazo_puzzf(x) {
  ...
  // * y(x("#canvas_1")[0], "tileData", canvas_1_width / 15, t, r); 
...
// console.log('selected_canvas = ', selected_canvas);
  ...
  // console.log('canvases_count in y() = ', canvases_count);
    ...
    // console.log('t_in_y = ', t);  // ! canvas_1 element, canvas_2 element and so on to 4th
    ...
    if (t == k && L && L.image_tiles) {     // todo what is    t == k    ?
      ...
      L[r].matching ||
        ...
        if(browser_width < browser_height){
          // let rotate_mask_btn = document.getElementById('puzzf_rotate_mask_btn');
          // rotate_mask_btn.style.opacity = '1';
          // rotate_mask_btn.style.cursor = 'pointer';
          // rotate_mask_btn.setAttribute('onclick', 'rotation(event);');

          // let rotate_mask_btn_2 = document.getElementById('puzzf_rotate_mask_btn_2');
          // rotate_mask_btn_2.style.opacity = '1';
          // rotate_mask_btn_2.style.cursor = 'pointer';
          // rotate_mask_btn_2.setAttribute('onclick', 'rotation_2(event);');

          let rotate_mask_btn_3 = document.getElementById('puzzf_save_image_key_btn');
          rotate_mask_btn_3.style.opacity = '1';
          rotate_mask_btn_3.style.cursor = 'pointer';
          rotate_mask_btn_3.setAttribute('onclick', 'create_pdf();');
        }
          ...
          canvas_1_width = canvas_1.width;


          // canvas_backside = document.getElementById('puzzf_canvas_backside_blk');
          // canvas_backside_width = canvas_backside.width;
          ...
          //   remainder_2 = Math.round(canvas_backside_width / 15) - (canvas_backside_width / 15);




          //   if((remainder_2 > 0.25) && (remainder_2 < 0.5)){
          //     // console.log('1');
          //     // console.log('Math.round(canvas_1_width / 15)= ', Math.round(canvas_1_width / 15));
             
          //     y(x("#puzzf_canvas_backside_blk")[0], "tileData", Math.round(canvas_backside_width / 15), t, r); //  Math.round(canvas_backside_width / 15) - 0.5

          //   }
          //   else if((remainder_2 > -0.5) && (remainder_2 < -0.25)){
          ...
          //   //   console.log('2');
          //   //   y(x("#canvas_1")[0], "tileData", Math.round(canvas_1_width / 15 + 0.5), t, r);    // !    / 15) + 0.5  plus
          //   // }
          //   // else if((remainder >= -0.76) && (remainder < -0.5)){
          //   //   y(x("#canvas_1")[0], "tileData", Math.round(canvas_1_width / 15) - 0.5, t, r);   
          //   // }
          //   else if(Math.round(canvas_1_width / 15) === 0){
          //     // console.log('3');
              
          //     y(x("#ppuzzf_canvas_backside_blk")[0], "tileData", Math.round(canvas_backside_width / 15), t, r);   //  Math.round(canvas_backside_width / 15) - 0.5
          ...
          //   }
          // }
          //console.log('canvas_1_width = ', canvas_1_width);

          // y(x("#canvas_1")[0], "tileData", canvas_1_width / 15, t, r); 


          // console.log('Math.round(canvas_1_width / 15) = ', Math.round(canvas_1_width / 15)); // ! one quadrate(integer)
          // console.log('canvas_1_width / 15 = ', canvas_1_width / 15); // ! one quadrate(float)
          let remainder = Math.round(canvas_1_width / 15) - (canvas_1_width / 15);
          ...
          // * 1
              if((remainder > 0.25) && (remainder < 0.5)){
                // console.log('1');
                // console.log('Math.round(canvas_1_width / 15)= ', Math.round(canvas_1_width / 15));
                y(x("#canvas_1")[0], "tileData", Math.round(canvas_1_width / 15), t, r);    // !    / 15) - 0.5  minus
               
  
              }
              else if((remainder > -0.5) && (remainder < -0.25)){
                y(x("#canvas_1")[0], "tileData", Math.round(canvas_1_width / 15), t, r); 
...
// ! 2
          ...
          pdf_link_2.style.display = 'block';
...
//   // ! tiles to the back side (start) phone_v



//               // ! id=puzzf_right_col_6_large_divs_wrp return to display:block; and in jigazo.js in   function rotation( event ) { uncomment some strings - in two places with red mark       if you want to return all 6-divs-borders back(tiles on the back side)
//   let num_dirs_ = global_value_obj_dirs_1;
...
//   // let rotate_mask_btn = document.getElementById('puzzf_rotate_mask_btn');
//   // let large_6_divs = document.getElementById('puzzf_right_col_6_large_divs_wrp');
//   // large_6_divs.style.opacity = '0';
//   // large_6_divs.style.zIndex = '0';

  
//             let back_blk_1 = document.getElementById('puzzf_backside_blk_1');
//             let back_blk_2 = document.getElementById('puzzf_backside_blk_2');
//             // back_blk.style.outline = 'none';
//             // back_blk.style.zIndex = '5';
//             // back_blk.style.transform = 'rotateY(-180deg)';
        
//             // back_blk_1.innerHTML = '';
//             back_blk_2.innerHTML = '';


// //             rotate_mask_btn.removeEventListener('click', rotation, false);
...
//             // large_6_divs.style.zIndex = '1';

//             // for(i=0; i < 6; ++i){
//             //   large_blk_one_of_6_[i].style.display = 'block';
//             //   // large_blk_one_of_6_[i].style.visibility = 'visible';
//             //   // large_blk_one_of_6_[i].style.opacity = '0';
//             //   if(i === 0){
//             //     large_blk_one_of_6_[i].style.borderLeft = '2px solid black';
//             //     large_blk_one_of_6_[i].style.borderTop = '2px solid black';
//             //     large_blk_one_of_6_[i].style.borderRight = '1px solid black';
...
//               // element.innerHTML = '<img style="pozition:absolute;width:74%;height:74%;margin-left:'+(browser_height * 0.0037)+'px;margin-top:'+(browser_height * 0.0037)+'px;transform-origin:center;transform:rotateZ('+angle+'deg);" src="images/shapes/'+svg_image_name+'" alt="symbol_img"><div style="position:absolute;outline:0px solid red;margin-left:'+(browser_height * 0.008)+'px;margin-top:'+(browser_height * 0.0075)+'px;transform-origin:center;transform:rotateZ('+angle+'deg);color:white;font-family: Arial, sans-serif;font-size:'+browser_height * 0.011+'px;font-weight:100;">'+array_tiles_in_line[ num_tiles_[mirrored_i]]['number']+'</div>';
//               // <div style="width:10px;height:10px;outline:1px solid black;">'+num_dirs_[i]+'</div>;
//               element.innerHTML = '<img style="pozition:absolute;width:74%;height:74%;transform:rotateZ('+angle+'deg);" src="images/shapes/'+svg_image_name+'" alt="symbol_img"><div style="position:absolute;outline:0px solid red;transform:rotateZ('+angle+'deg);color:white;font-family: Arial, sans-serif;font-size:'+browser_width * 0.022+'px;">'+array_tiles_in_line[ num_tiles_[mirrored_i]]['number']+'</div>';
  
//               back_blk_2.appendChild(element);
...
// // ! tiles to the back side (end) phone_v
...
// // back_blk.appendChild(element);
          ...
          // let zoom_el = document.getElementById('puzzf_zoom');
          // let image_el = document.getElementById('puzzf_image');
          // zoom_el.style.pointerEvents = 'auto';
          // image_el.style.pointerEvents = 'auto';

            // have_overlay = false;
            // setTimeout(have_overlay_to_false(),5000);
            // function have_overlay_to_false(){
             //have_overlay = false; // ? ????????????????????????? 26.05.23
            // }

            // let puzzf_image = document.getElementById('puzzf_image');
            // puzzf_image.style.pointerEvents = 'auto';
            
            // setTimeout(enable_events(), 500);
...
// console.log('t.src = ', t.src);
 ...
 // console.log('r_in_A_func_1= ', r);   // todo   r_in_A_func=  0   // todo   r_in_A_func=  1   when k++; on 779 line is uncomment  and we have only ONE console.log()  !!! - where is the second? and also we have only first canvas with puzzles
                        ...
                        a = cropped_img;
                        e = x("#orig")[0],       // ! orig is needed BECAUSE we have properly size of canvas_1 2 3 4
//console.log('e = ', e);   // todo    <canvas id="orig" style="display:none
                          //console.log('e = ', e);       // * <canvas id="canvas_1" class="puzzf_canvases" style="\n    

                          n = a.height > a.width;
                        (L.is_portrait = n)
                          ? ((e.width = b * I), (e.height = b * D))                       // ? **************************** e.width = set new width of canvas_1 
